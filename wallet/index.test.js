...
describe('Wallet', () => {
    ...
    describe('creating a transaction', () => {
        ...
        describe('and doing the same transaction', () => {
            ...
            it('doubles the sendAmount subsctucted from the wallet balance', () => {
    ...
    describe('calculation a balance', () => {
        ...
        it('calculates the balance for blockchain transactions mathing the recipient', () => {
